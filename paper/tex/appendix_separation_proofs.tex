...
$S=\{|\Delta|\ge G-\eta',a^*=j\}$, with $j$ attaining $\nu=\nu_{\eta'}$. There
$q_\tau\le \exp(-(G-\eta')/\tau)$, so $\bar N\le n\nu \exp(-(G-\eta')/\tau)$, and the van
Trees step of Theorem~\ref{thm:info} with $K=1$ gives
$\delta_n^2\ge \nu^2\sigma^2/(n\nu \exp(-(G-\eta')/\tau)+\sigma^2\pi^2/B^2)$. Once
$\delta_n^2\le \nu^2B^2/(2\pi^2)$, this forces
$n\nu \exp(-(G-\eta')/\tau)\ge \nu^2\sigma^2/(2\delta_n^2)$, that is,
$\tau_n\ge(G-\eta')/\log\{2n\delta_n^2/(\nu\sigma^2)\}$, where the logarithm is
