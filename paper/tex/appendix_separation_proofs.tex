...
K(u)\le \exp(-|u|),\quad \int_0^\infty v\,\sgm(-v)\,dv=\tfrac{\pi^2}{12}.
\]
...
loss is $n\E[gq]\le nc_n\E\sqrt g$. The uniform design is analogous. \qed
...
$\tau_n\ge(G-\eta')/\log\{2n\delta_n^2/(\nu\sigma^2)\}$. On the other hand
$R_n=n\E[\phi(|\Delta|)q_\tau]=n\E[\phi(|\Delta|)\sgm(-|\Delta|/\tau)]\ge n\kappa f_{\min}\tau^2\int_0^{u_0/\tau}v\sgm(-v)dv\ge
...
$\Delta_{\min}$ cell contributes $n f\phi(\Delta_{\min})\exp(-\Delta_{\min}/\tau)/2$. \qed
...
\paragraph{Proof of Lemma~\ref{lem:robust}.} With the cap slack, $q=c/\sqrt{\hat g}$ and
$\E[1/q]=T$, the loss is $n\E[\sqrt{\hat g}]\E[g/\sqrt{\hat g}]/T$, against
