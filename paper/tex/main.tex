...
\emph{The joint limit is unresolved.} The $(n,\tau)$ phase structure is a
simulation finding. On a widened grid, neither $\log\E[e^{D}]$ nor an
upper-tail functional of $D$ gives a stable offset to the measured
transition across our two designs, so we do not claim to know which
functional governs it.
