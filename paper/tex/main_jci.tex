...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figs/fig1_separation_map.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figs/fig2_temperature_curve.pdf}
...
seeds and code commits), plain-text versions of the proofs, and the scripts that
generate every number, table and figure in the paper are available in
the repository
